...
const PARAMS = [
  ...
  { key: "dofFocusFar", label: "DoF Focus Far", min: 0.1, max: 10000, step: 1 },
  { key: "dofBlurNear", label: "DoF Blur Near", min: 0.1, max: 50, step: 0.1 },
  { key: "dofBlurFar", label: "DoF Blur Far", min: 0.1, max: 9900, step: 1 },
  ...
  { key: "grassDenseDensity", label: "Grass Near Density", min: 0.25, max: 1, step: 0.05 },
